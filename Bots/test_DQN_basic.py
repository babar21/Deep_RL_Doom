...
file_handler = FileHandler('activity_dqn_basic_1.log')
...
reward_builder = Reward(dic_reward=reward, default=False) # default rewards
print(reward_builder.default_reward)
custom_reward=True
